  ...
  <div class="Wrapper">
    ...
    <section class="Attention">
      ...
      foreach ($filteredResults as $result) {
        if ($result && isset($result['serviceName']) && isset($result['noteAll'])) {
          echo '<p>';
          echo '■' . htmlspecialchars((string)$result['serviceName'], ENT_QUOTES, 'UTF-8') . '<br>';
          echo htmlspecialchars_decode((string)$result['noteAll'], ENT_QUOTES);
          echo '</p>';
        }
      }
      ?>
