...
// ランキングデータの取得
if (!empty($topData['rankingCardId'])) {
  $ranking1stDataId = isset($topData['rankingCardId'][0]) ? $topData['rankingCardId'][0] : null;
  $ranking2ndDataId = isset($topData['rankingCardId'][1]) ? $topData['rankingCardId'][1] : null;
  $ranking3rdDataId = isset($topData['rankingCardId'][2]) ? $topData['rankingCardId'][2] : null;
...
// 銀行ランキングデータの取得
if (!empty($topData['rankingBankCardId'])) {
  $bankRanking1stDataId = isset($topData['rankingBankCardId'][0]) ? $topData['rankingBankCardId'][0] : null;
  $bankRanking2ndDataId = isset($topData['rankingBankCardId'][1]) ? $topData['rankingBankCardId'][1] : null;
  $bankRanking3rdDataId = isset($topData['rankingBankCardId'][2]) ? $topData['rankingBankCardId'][2] : null;
